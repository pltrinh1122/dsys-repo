# Captured exemplar: `skill-creator` SKILL.md

> Provenance: pasted by Peter in chat on 2026-09-20, described as the
> "/skill-creator" slash-command bundled with Claude Code. Captured
> verbatim below as an exemplar of slash-command/skill implementation
> craft. Nothing below this header has been edited; the leading
> separator lines are as received.
...
Bad: `"Format this data"`, `"Extract this text from PDF"`, `"Create a chart"`
...
- `references/schemas.md` — JSON structures for evals.json, eval_metadata.json, grading.json, etc.
